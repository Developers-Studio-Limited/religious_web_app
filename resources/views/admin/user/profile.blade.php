...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
        ...
        <div class="row col-md-12">
            ...
            <div class="kt-grid__item kt-app__toggle col-md-8" id="kt_user_profile_aside">
                        ...
                        <div class="kt-widget kt-widget--user-profile-1">
                            <div class="kt-widget__head">
                                <div class="kt-widget__media">
                                    ...
                                    @else
                                        <img src="{{asset('admin_assets/img/no-image.jpg')}}" alt="image">
                                    @endif
                                </div>
                            ...
                            <div class="kt-widget__body">
                                <div class="kt-widget__content">
                                    ...
                                    <div class="kt-widget__info">
                                        ...
                                        <span class="kt-widget__data">{{$user->birth_date}}</span>
                                    </div>
                                </div>
                                <a href="{{route('delete-user', $user->id)}}" class="btn btn-danger btn-block">Delete</a>
                                {{-- <div class="kt-widget__items">
                                    ...
                                    <a href="#" class="kt-widget__item" data-toggle="kt-tooltip" title="Coming soon..."
                                            ...
                                            <div class="kt-widget12__progress">
                                                <div class="progress kt-progress--sm">
                                                    <div class="progress-bar kt-bg-brand" role="progressbar"
                                                        style="width: 40%;" aria-valuenow="100" aria-valuemin="0"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        ...
                                                        <rect fill="#000000" opacity="0.3" x="2" y="9" width="20"
                                                            height="13" rx="2" />
                                                        <rect fill="#000000" opacity="0.3" x="5" y="5" width="14"
                                                            height="2" rx="0.5" />
                                                        <rect fill="#000000" opacity="0.3" x="7" y="1" width="10"
                                                            height="2" rx="0.5" />
                                                        <path
...
<script src="{{asset('admin_assets/js/user/profile.js')}}" type="text/javascript"></script>
@endsection